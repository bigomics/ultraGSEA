...
visually determine the method with highest TPR and lowest FPR (Figure
5). We see that GOAT performs the best with similar low FPR but
...
Finally, by comparing the runtimes of the methods we see that
ultragsea, in this benchmark, is almost 100x faster than fGSEA and
about 10x faster than cameraPR and the naively implemented ORA
Fisher's exact test (Fisher). PLAID, a single-sample enrichment
method, is still very fast. The ultragsea methods (ultraGSEA.cor and
