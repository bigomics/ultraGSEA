...
algorithm for pre-ranked enrichment testing. See: [github](https://github.com/alserglab/fgsea).
...
In particular we are interested as how we compare to these algorithms
in terms of runtime, score and p-value.
