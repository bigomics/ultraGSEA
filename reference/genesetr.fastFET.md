# Fast version of Fisher Exact Test from 'genesetr' R package. Quickly compute FET p-values for n 2x2 contingency tables T = {t_1,t_2,...,t_n-1,t_n}
...
``` r
genesetr.fastFET(a, b, c, d, alternative = "greater")
```
