...
res2a <- gset.ztest(F, G, alpha=0)
res2b <- gset.ztest(F, G, alpha=1)
res3a <- gset.ztest(F, G, pdist="t", alpha=0)
res3b <- gset.ztest(F, G, pdist="t", alpha=1)
res4a <- gset.ztest(F, G, center=FALSE, alpha=0)
res4b <- gset.ztest(F, G, center=FALSE, alpha=1)
res5a <- gset.ztest(F, G, pdist="t", center=FALSE, alpha=0)
res5b <- gset.ztest(F, G, pdist="t", center=FALSE, alpha=1)
